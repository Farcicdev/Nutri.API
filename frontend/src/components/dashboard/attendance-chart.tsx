...
export function AttendanceChart({ atendimentos }: { atendimentos: AtendimentoPorMes[] }) {
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        <CardTitle className="font-serif text-lg">Evolução de atendimentos</CardTitle>
      ...
      <CardContent className="h-[300px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={dados} margin={{ left: -16, right: 8, top: 8 }}>
            ...
            <XAxis dataKey="mes" tickLine={false} axisLine={false} tickMargin={10} fontSize={12} />
            <YAxis allowDecimals={false} tickLine={false} axisLine={false} width={38} fontSize={12} />
            <Tooltip
